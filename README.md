...
[Project](https://yininghase.github.io/multi-agent-control/) | [Paper](https://arxiv.org/abs/<ARXIV PAPER ID>)
...
## U Attention Convolution Block 

Here we show our proposed U Attention Convolution Block. Please refer to [here](./supplementary.pdf) for the detailed explanation of U Attention Convolution Block.
...
We also provide the dataset generated by us. You can download trainval dataset [here](https://drive.google.com/file/d/1hT7ilHITG7ow9MeUpn_Nd7dQkaiEFS8X/view?usp=drive_link) and test dataset [here](https://drive.google.com/file/d/1QdH_Uf_anaHmLmOB-m6auD6_ibtGcjbk/view?usp=sharing).
...
- **Calculation of step efficiency**
